    ...
    return (
      ...
      >
        ...
        <AlertDescription className="text-sm text-amber-900 dark:text-amber-100">
          <strong>Important:</strong> This app is not a medical device and does
          not provide diagnosis or emergency response. In an emergency, call
          999. For medical advice, contact your GP or NHS 111.
        </AlertDescription>
      </Alert>
    );
  }
